...
const dataObj = {
  ...
  defaultAdminPw: appConfig.adminPw,
};
...
<meta name="apple-mobile-web-app-title" content="SG 한팀장">
<style>
${css}
</style>
  ...
  <aside class="sidebar" id="sidebar">
    <div class="sidebar-brand">
      ...
      <div class="sidebar-brand-text">
        <div class="brand-mark">SG 한팀장</div>
  ...
  <div class="main">
    <div class="header">
      ...
      <div class="header-text">
        <div class="title" id="headerTitle">SG 한팀장</div>
